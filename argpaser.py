...
def argparse_option():
    ...
    parser.add_argument('--lambRECT', type=float, default=1.4, help='coefficient for the RECT loss function')
    parser.add_argument('--CACO', action='store_true', default=False, help='CACO loss function')
    parser.add_argument('--lambCACO', type=float, default=0, help='coefficient for the CACO loss function')
    parser.add_argument('--CVDC', action='store_true', default=False, help='CVDC loss function')
    parser.add_argument('--lambCVDC', type=float, default=0, help='coefficient for the CVDC loss function')
    ...
    parser.add_argument('--upper_bound', type=float, default=200,
    ...
    parser.add_argument('--CS_iterations', type=int, default=200, help='CS iteration')
